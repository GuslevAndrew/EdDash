...
const dynamicsVariablesHelpText =
  "За допомогою чекбоксів можна додати на графік окремі лінії для показників, вибраних у фільтрах. Це дозволяє порівнювати динаміку за закладами освіти, регіонами, галузями, спеціальностями, освітніми рівнями або формами навчання. Також можна вибрати конкретні дати, щоб відобразити їх на графіку та порівняти між собою. Завдяки цьому ви можете сформувати власний зріз даних і переглянути саме ті показники, які важливі для вашого аналізу.";
